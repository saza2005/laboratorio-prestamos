...
const expected = {
  runner: 'ba7cf1fa80d8a282119564bace999e36ae43c29b780d606191008bc1751fb6d2',
...
function fail(code) {
  console.error(`L1_F3LO_RECOVERY: FAIL_CLOSED (${code})`)
  process.exitCode = 1
...
const currentArtifactHashes = {
  runner: await hashFile('scripts/e2e/run-flow-l1-b-delivery-v5.mjs'),
...
const record = {
  ...
  recovery: { tool: 'recover-l1-current-attempt-f3lo.mjs', result: 'MUTATION_COMPLETE_POST_VERIFY_PASS', consumed: true },
  artifactHashes,
...
console.log(`L1_F3LO_RECOVERY: PASS ${classification.name} DELIVERY=${classification.delivery} REMOTE_POST_VERIFY=PASS HISTORY_APPEND=PASS TRACKER_POSTSTATE=PRISTINE`)
