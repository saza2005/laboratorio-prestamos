...
const expected = {
  ...
  f3ig: '7b001e4cb6e49be9c67c4bc0ab0195644bc31b77d76a93eaf2d943d1b9292f5d',
}

function fail(code) {
  console.error(`L1_F3LE_RECOVERY: FAIL_CLOSED (${code})`)
  process.exitCode = 1
...
const record = {
  ...
  recovery: { tool: 'recover-l1-current-attempt-f3le.mjs', result: 'MUTATION_COMPLETE_POST_VERIFY_PASS', consumed: true },
  artifactHashes,
...
console.log(`L1_F3LE_RECOVERY: PASS ${classification.name} DELIVERY=${classification.delivery} REMOTE_POST_VERIFY=PASS HISTORY_APPEND=PASS TRACKER_POSTSTATE=PRISTINE`)
