...
function fail(code) {
  console.error(`L1_F3LG_RECOVERY: FAIL_CLOSED (${code})`)
  process.exitCode = 1
...
const record = {
  ...
  recovery: { tool: 'recover-l1-current-attempt-f3lg.mjs', result: 'MUTATION_COMPLETE_POST_VERIFY_PASS', consumed: true },
  artifactHashes,
...
console.log(`L1_F3LG_RECOVERY: PASS ${classification.name} DELIVERY=${classification.delivery} REMOTE_POST_VERIFY=PASS HISTORY_APPEND=PASS TRACKER_POSTSTATE=PRISTINE`)
