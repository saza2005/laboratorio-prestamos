...
requireProof(statementIndex(runnerTry.tryBlock, cleanupCallStatement, 'cleanup') < statementIndex(runnerTry.tryBlock, completeCall.parent.parent, 'complete'), 'cleanup_before_complete')
...
const postattempt = {
  ...
  COMPLETE_DOMINANCE: uniqueProof('COMPLETE_DOMINANCE', () => {
    requireProof(noContinuationAfter(runnerTry.tryBlock, completeCall.parent.parent) ||
      statementIndex(runnerTry.tryBlock, cleanupCallStatement, 'cleanup') < statementIndex(runnerTry.tryBlock, completeCall.parent.parent, 'complete'), 'complete_path')
  }),
}
...
const replacements = {
  ...
  CLEANUP_SUCCESS_DOMINANCE: uniqueProof('CLEANUP_SUCCESS_DOMINANCE', () => {
    requireProof(statementIndex(runnerTry.tryBlock, cleanupCallStatement, 'cleanup_success') < statementIndex(runnerTry.tryBlock, completeCall.parent.parent, 'complete_success'), 'cleanup_success_order')
