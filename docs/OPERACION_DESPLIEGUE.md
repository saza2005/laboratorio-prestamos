...
11. Hacer respaldo de base de datos antes de importar o reemplazar inventario.
...
- Si una RPC no está aplicada, las acciones pueden fallar aunque el frontend compile.
